  ...
  const handleUpgradeToPremium = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        alert("Successfully upgraded to premium! Please complete the payment.");
        onClose();
      } else {
        ...
        <div className="p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-300">Manual payment</div>
                </div>
              </button>
              <button
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <button
                        onClick={() => copyToClipboard(bankAccountInfo.bankName)}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <button
                        onClick={() => copyToClipboard(bankAccountInfo.accountNumber)}
                        className="text-electric-blue-500 hover:text-electric-blue-600 transition-colors"
                        title="Copy to clipboard"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <button
                        onClick={() => copyToClipboard(bankAccountInfo.accountName)}
                        className="text-electric-blue-500 hover:text-electric-blue-600 transition-colors"
                        title="Copy to clipboard"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-300">SWIFT Code:</span>
                    <div className="flex items-center space-x-2">
                      <span className="font-mono font-medium text-gray-900 dark:text-white">
                        {bankAccountInfo.swiftCode}
                      </span>
                      <button
                        onClick={() => copyToClipboard(bankAccountInfo.swiftCode)}
                        className="text-electric-blue-500 hover:text-electric-blue-600 transition-colors"
                        title="Copy to clipboard"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div className="text-sm text-blue-700 dark:text-blue-300">
                    ...
                    <ul className="space-y-1 text-xs">
                      <li>• Transfer the exact amount: <strong>{bankAccountInfo.amount} {bankAccountInfo.currency}</strong></li>
                      <li>• Include your username in the transfer description</li>
                      <li>• Premium access will be activated within 24 hours</li>
          ...
          {paymentMethod === 'online' && (
            <div className="mb-6 p-6 bg-gray-50 dark:bg-gray-700 rounded-lg text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Online payment integration is coming soon. Please use bank transfer for now.
              </p>
            </div>
          )}

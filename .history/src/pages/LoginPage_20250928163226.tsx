  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-200">
      <div className="max-w-md w-full space-y-8">
        <div>
          <div
            className="mx-auto h-12 w-12 bg-electric-blue flex items-center justify-center"
          ...
          <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link
              to="/register"
              className="font-medium text-electric-blue hover:text-blue-400 transition-colors duration-200"
            >
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-electric-blue focus:border-transparent"
